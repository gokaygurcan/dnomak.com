<template lang="pug">
  div
    ...
    .wrap.xl-center.xl-ba-white.xl-bwb2.xl-bo-gray-200
      .col.xl-8-12.lg-1-1
        .xl-m40.md-m24
          input(type='text', v-model='keyword', @input='searchInTags', :placeholder='$t("globals.searchPlaceholder")', class='xl-fs18 xl-1-1 xl-db xl-h56 xl-ba-white xl-bw2 xl-bo-gray-200 xl-br8 xl-brr0 xl-ffscp xl-pl16 lg-pl8 md-pl16 pl-co-gray-500')
    .xl-px16
      .container
        .wrap.xl-3.xl-left.xl-gutter-16.lg-2.md-1.md-gutter
          .col(v-for='tag in AllTags' v-if='tag.humans.length')
            .xl-mt24.xl-ffscp.xl-mb16.xl-fs24.xl-dib.xl-py8.xl-px16.xl-br8(:class='tag.name') {{ tag.name }}
            .xl-pr.xl-mb8
              .shadow
              .scroll
                div(v-for='human in tag.humans')
                  router-link.xl-ba-white.xl-bo-gray-200.xl-co-black-500.link.xl-bw2.xl-db.xl-oh.xl-cp.xl-tal.xl-br8.xl-bw2.xl-p8.xl-mb16(:to='{ name: "human", params: { username: human.username }}')
                    .wrap.xl-auto.xl-middle.xl-table
                      .col(style='width: 80px;')
                        .avatar--tags.xl-br8(:style="{ 'background-image': 'url(/static/img/youtube/' + human.username + '.jpg)' }")
                      .col.xl-px16
                          .xl-mb4.xl-lh24
                            .wrap.xl-auto.xl-middle.xl-gutter-8
                              .col
                                .xl-dib.xl-fs20.xl-fw600 {{ human.name }}
                          div.xl-fw400.xl-fs14.xl-lh24(v-if='human.title')
                            |{{ human.title }}
</template>
